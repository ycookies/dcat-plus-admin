   ...
   */
    ...
    */
    'grid' => [
        ...
        'batch_action_class' => Dcatplus\Admin\Grid\Tools\BatchActions::class,

        // The global Grid pagination display class.
        'paginator_class' => Dcatplus\Admin\Grid\Tools\Paginator::class,

        'actions' => [
            'view' => Dcatplus\Admin\Grid\Actions\Show::class,
            'edit' => Dcatplus\Admin\Grid\Actions\Edit::class,
            'quick_edit' => Dcatplus\Admin\Grid\Actions\QuickEdit::class,
            'delete' => Dcatplus\Admin\Grid\Actions\Delete::class,
            'batch_delete' => Dcatplus\Admin\Grid\Tools\BatchDelete::class,
        ],

        // The global Grid column selector setting.
        'column_selector' => [
            'store' => Dcatplus\Admin\Grid\ColumnSelector\SessionStore::class,
            'store_params' => [
                'driver' => 'file',
            ],
        ],
