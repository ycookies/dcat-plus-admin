...
<head>
    ...
    <script src="{{asset('vendor/dcat-admin/dcat/plugins/apidoc/apidoc-web-components.min.js')}}"></script>
    <link rel="stylesheet" href="{{asset('vendor/dcat-admin/dcat/plugins/apidoc/apidoc-styles.min.css')}}">
