            ...
            <div class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 input-group">
                        ...
                        <div class="vs-checkbox-con vs-checkbox-primary" style="margin-left: 16px">
                            <input value="" name="is_add_admin_api" type="checkbox">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5 input-group">
                        ...
                        <div class="vs-checkbox-con vs-checkbox-primary" style="margin-left: 16px">
                            <input value="" name="is_add_member_api" type="checkbox" >
                            <span class="vs-checkbox vs-checkbox-">
                              <span class="vs-checkbox--check">
                                <i class="vs-icon feather icon-check"></i>
                              </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 form-field ">
                                <div class="input-group iconpicker-container">
                                    <span class="input-group-prepend"><span class="input-group-text bg-white"><i class="fa fa-align-justify">&nbsp;</i></span></span>
                                    <input autocomplete="off" style="width: 160px;flex:none" type="text" name="menu_icon" value="fa-align-justify" class="form-control scaffold_menu_icon field_icon _normal_ iconpicker-element iconpicker-input" placeholder="选择菜单图标">
...
<script>
    Dcat.ready(function () {
        ...
        $('select').select2();
        $('select[name="parent_menu"]').val('0').trigger('change');
