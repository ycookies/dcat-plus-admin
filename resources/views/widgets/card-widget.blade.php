                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            项目 <span class="float-right badge bg-primary">31</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            任务 <span class="float-right badge bg-info">5</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            产品 <span class="float-right badge bg-success">12</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            关注 <span class="float-right badge bg-danger">842</span>
                        </a>
                    </li>
                </ul>
            </div>
...
<div class="row mt-4">
    <div class="col-sm-4">
        <div class="position-relative">
            <img src="https://adminlte.io/themes/v3/dist/img/photo1.png" alt="Photo 1" class="img-fluid">
            <div class="ribbon-wrapper ribbon-lg">
                <div class="ribbon bg-success text-lg">
                    618大促
                </div>
    ...
    <div class="col-sm-4">
        <div class="position-relative">
            <img src="https://adminlte.io/themes/v3/dist/img/photo2.png" alt="Photo 2" class="img-fluid">
            <div class="ribbon-wrapper ribbon-xl">
                <div class="ribbon bg-warning text-lg">
                    双11大促
                </div>
    ...
    <div class="col-sm-4">
        <div class="position-relative" style="min-height: 180px;">
            <img src="https://adminlte.io/themes/v3/dist/img/photo3.jpg" alt="Photo 3" class="img-fluid">
            <div class="ribbon-wrapper ribbon-xl">
                <div class="ribbon bg-danger text-xl">
                    百亿补贴
                </div>
...
<div class="accordion faq-box" id="accordion">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-md shadow">
            <div class="card-body text-center">
                <div class="text-uppercase text-muted font-weight-medium">免费</div>
                <div class="display-5 my-3">￥0</div>
                <ul class="list-unstyled lh-lg">
                    <li><strong>3</strong>人坐席</li>
                    <li>
                        <i class="feather icon-check text-success lead"></i>Sharing Tools
                    </li>
                    <li><i class="feather icon-x text-danger lead"></i> Design Tools
                    </li>
                    <li><i class="feather icon-x text-danger lead"></i>Private Messages
                    </li>
                    <li><i class="feather icon-x text-danger lead"></i> Twitter API
                    </li>
                </ul>
                <div class="text-center mt-4">
                    <a href="#" class="btn w-100">订 购</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3">
        <div class="card card-md shadow">
            ...
            <div class="card-body text-center">
                ...
                <div class="text-center mt-4">
                    <a href="#" class="btn btn-success w-100">订 购</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
                <a href="#" class="d-block"><img src="https://tabler.bootmb.com/static/photos/1b73704b282a8ec6.jpg"
                                                 class="card-img-top"></a>
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <span class="avatar me-3 rounded"
                              style="background-image: url(https://tabler.bootmb.com/static/avatars/000m.jpg)"></span>
                        <div>
                            <div>Paweł Kuna</div>
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
                <a href="#" class="d-block"><img src="https://tabler.bootmb.com/static/photos/3d2998219313cd37.jpg"
                                                 class="card-img-top"></a>
                <div class="card-body">
                    <div class="d-flex align-items-center">
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card card-sm">
                <a href="#" class="d-block"><img src="https://tabler.bootmb.com/static/photos/6ab3200b14549f8a.jpg"
                                                 class="card-img-top"></a>
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <span class="avatar me-3 rounded"
                              style="background-image: url(https://tabler.bootmb.com/static/avatars/002m.jpg)"></span>
                        <div>
...
<style>
    ...
    .user-card .card-btn:hover {
        text-decoration: none;
        background: rgba(32,107,196,.06)
    }

    .user-card .card-btn:not(:first-child) {
    ...
    <div class="row row-cards">
        <div class="col-md-6 col-lg-3">
            <div class="card shadow">
                ...
                <div class="d-flex">
                    <a href="#" class="card-btn"> <i class="feather icon-mail lead"></i>&nbsp;&nbsp;邮箱</a>
                    <a href="#" class="card-btn"> <i class="feather icon-phone-call lead"></i>&nbsp;&nbsp;电话</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="card shadow">
                <div class="card-body p-4 text-center">
                    <span class="avatar avatar-xl mb-3 avatar-rounded" style="background-image: url(https://tabler.bootmb.com/static/avatars/002m.jpg)"></span>
...
<div><h2>fieldset</h2></div>
<div class="fieldset-box">
    <fieldset class="fieldset">
        <legend class="legend">123</legend>
                ...
                <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                    <div class="card border-light mb-3 shadow">
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="lead"><b>小可可丽</b></h2>
                                    <p class="text-muted text-sm"><b>关于: </b> Web Designer / UX / Graphic Artist / Coffee Lover </p>
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                        <li class="small"><span class="fa-li"><i class="feather icon-map"></i></span> Address: Demo Street 123, Demo City 04312, NJ</li>
                                        <li class="small"><span class="fa-li"><i class="feather icon-phone-outgoing"></i></span> Phone #: + 800 - 12 12 23 52</li>
                                    </ul>
                                </div>
                                <div class="col-5 text-center">
                                    <img src="https://m.saishiyun.net/imgpic/work-photo.png" data-action='preview-img'  class="preview-img img-circle img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <div class="text-right">
                                <a href="#" class="btn btn-sm bg-teal">
                                    <i class="feather icon-message-circle lead"></i>
                                </a>
                                <a href="#" class="btn btn-sm btn-primary">
                                    <i class="feather icon-user lead"></i> 查看主页
                                </a>
                            </div>
                        </div>
                    </div>
