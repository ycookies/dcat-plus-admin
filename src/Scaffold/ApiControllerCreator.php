...
class ApiControllerCreator
{
    ...
    /**
     * 获取数据表字段（兼容 MySQL/MariaDB、SQLite、PostgreSQL）.
     *
     * 返回结构尽量与 SHOW FULL COLUMNS 一致：
     * Field / Type / Null / Default / Comment / Key
     *
     * @param string $table
    ...
    {
        return TableColumnInspector::getShowLikeColumns((string) $table);
    }
}
